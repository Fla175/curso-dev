...
insert into tb_info(titulo, descricao)values('Missao', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.');
insert into tb_info(titulo, descricao)values('Visao', 'Morbi faucibus elit nec nibh elementum, a ultrices ante condimentum.');
